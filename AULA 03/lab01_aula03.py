"""
LAB 01 - AULA 03
Raycasting 2D com 3 sensores de distancia (Esquerda, Frente, Direita)
Baseado no codigo fornecido pelo professor, apenas revisado e comentado.

Como testar: mova o mouse pela tela, o robo persegue o cursor
e os 3 raios mostram a distancia ate os obstaculos (retangulos vermelhos).
"""
...
class RaycastDemoRobot:
    def __init__(self, x, y, theta=0.0):
        ...
        # angulos relativos dos sensores: Esquerda, Frente, Direita
    ...
    def cast_rays(self, obstacles):
        """Verifica a intersecao dos raios com obstaculos retangulares."""
        self.sensor_readings = []
        for beta in self.sensor_angles:
            angle = self.theta + beta
            min_dist = self.sensor_range

            # raymarch simplificado: caminha em passos de 4px ao longo do raio
            for step in range(5, int(self.sensor_range), 4):
                ...
                # colisao com algum dos retangulos de obstaculo
                hit = False
...
def main():
    ...
    pygame.display.set_caption("LAB 01 - Raycasting e Percepcao Sensorial")
    ...
    while running:
        ...
        # o robo segue o mouse so pra facilitar testar os sensores
        ...
        leituras = [
            f"Sensor {['Esq', 'Frente', 'Dir'][i]}: {dist:5.1f} px"
        ...
        screen.blit(
            font.render("Mova o mouse para testar a deteccao dos sensores.", True, (255, 215, 0)),
            (20, 90),
        )
